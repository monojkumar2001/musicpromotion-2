...
const FaqSectionLyricVideo = ({ type = "one" }) => {
	return (
		<section id="faq">
			<div className="container">
				...
				{[1].map((item) => (
					<Accordion key={item}>
						...
						As soon you place the order, we start working on your order within 24 hours of receiving all necessary information and file. After that, it might take around 3-5 business days to deliver your lyric video, depending on the complexity of the entire project.
						</p>
					</Accordion>
				))}
				{[2].map((item) => (
					<Accordion key={item}>
						...
						<p className="accordion-body">
						Yes, we have a team of professional designer video editor, animators & sound designers they will make these videos with a complete unique & creative idea depending on the package you buy from us according to your music genre & given information.
						</p>
					</Accordion>
...
export default FaqSectionLyricVideo;
