...
const FaqSectionSoundCloud = ({ type = "one" }) => {
	return (
		<section id="faq">
			<div className="container">
				...
				{[4].map((item) => (
					<Accordion key={item}>
						<AccordionHeader>How long does it take to see engagements coming over from this SoundCloud promotion service?</AccordionHeader>
						<p className="accordion-body">
				...
				{[5].map((item) => (
					<Accordion key={item}>
						<AccordionHeader>Can you guys also promote SoundCloud artist profile/albums/playlists?</AccordionHeader>
						<p className="accordion-body">
				...
				{[6].map((item) => (
					<Accordion key={item}>
						<AccordionHeader>Why you should buy this SoundCloud Promotion service?</AccordionHeader>
						<p className="accordion-body">
						Through our SoundCloud promotion service, you can easily grow your audience base the right way. But be noted we do not provide any bot streams. There is no such chance that bot can grow your SoundCloud fanbase.
						</p>
					</Accordion>
				...
				{[7].map((item) => (
					<Accordion key={item}>
						<AccordionHeader>Where do you promote my SoundCloud music?</AccordionHeader>
						<p className="accordion-body">
				...
				{[9].map((item) => (
					<Accordion key={item}>
						<AccordionHeader>Is it completely safe for my SoundCloud channel?</AccordionHeader>
						<p className="accordion-body">
						First of all, as we said it’s a real & organic music promotion service. Which complies with SoundCloud terms & conditions. Beside that we guarantee the privacy of your personal data as well your SoundCloud artist's account is completely protected from any risks.
						</p>
					</Accordion>
...
export default FaqSectionSoundCloud;
